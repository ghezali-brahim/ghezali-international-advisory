...
const ServicesPage = () => {
  ...
  return (
    <div className="pt-16">
      ...
      <section id="private-equity-advisory" className="py-12 sm:py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-black mb-3 sm:mb-4">Private Equity Advisory</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">Portfolio transformation, board-level task force, aligned success fee and equity.</p>
          </div>
          <div className="space-y-16 sm:space-y-20 lg:space-y-24">
            {services.map((service, index) => (
              <div key={index} className={`${index % 2 === 1 ? 'lg:flex-row-reverse' : ''} flex flex-col lg:flex-row items-center gap-10 sm:gap-12 lg:gap-16`}>
                {/* Content */}
                <div className="lg:w-1/2 w-full">
                  <div className="flex items-center mb-4 sm:mb-6">
                    <service.icon className="h-10 w-10 sm:h-12 sm:w-12 text-yellow-600 mr-3 sm:mr-4 flex-shrink-0" />
                    <div>
                      <h2 className="text-2xl sm:text-3xl font-serif text-black">{service.title}</h2>
                      <p className="text-base sm:text-lg text-yellow-600 font-semibold">{service.subtitle}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
                      ...
                      <p className="text-xl sm:text-2xl font-bold text-yellow-600">{service.price}</p>
                    </div>
                    <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
                      <div className="flex items-center mb-3 sm:mb-4">
                      ...
                      <p className="text-xl sm:text-2xl font-bold text-yellow-600">{service.duration}</p>
                    </div>
                  </div>

                  <div className="mb-6 sm:mb-8">
                    <h3 className="text-lg sm:text-xl font-semibold text-black mb-3 sm:mb-4">Key benefits</h3>
                  ...
                  <button className="bg-black text-white hover:bg-gray-800 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg transition-all duration-300 flex items-center min-h-[44px]">
                ...
                {/* Features Card */}
                <div className="lg:w-1/2 w-full">
                  <div className={`${service.color} p-5 sm:p-6 lg:p-8 rounded-2xl text-white`}>
                    <h3 className="text-xl sm:text-2xl font-serif mb-4 sm:mb-6">What is included</h3>
                    ...
                    <div className="border-t border-white/20 pt-4 sm:pt-6">
                      <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Our methodology</h4>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-3">
            <div className="bg-white p-5 sm:p-6 lg:p-8 rounded-xl shadow-lg text-center">
              <Shield className="h-10 w-10 sm:h-12 sm:w-12 text-yellow-600 mx-auto mb-4 sm:mb-6" />
              <h3 className="text-lg sm:text-xl font-semibold text-black mb-3 sm:mb-4">Result guarantee</h3>
            ...
            <div className="bg-white p-5 sm:p-6 lg:p-8 rounded-xl shadow-lg text-center">
              <Zap className="h-10 w-10 sm:h-12 sm:w-12 text-yellow-600 mx-auto mb-4 sm:mb-6" />
              <h3 className="text-lg sm:text-xl font-semibold text-black mb-3 sm:mb-4">24h responsiveness</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white p-5 sm:p-6 lg:p-8 rounded-xl shadow-lg text-center">
              <CheckCircle className="h-10 w-10 sm:h-12 sm:w-12 text-yellow-600 mx-auto mb-4 sm:mb-6" />
              <h3 className="text-lg sm:text-xl font-semibold text-black mb-3 sm:mb-4">Absolute confidentiality</h3>
              <p className="text-gray-600 mb-6">
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 sm:space-x-0">
            <LocaleLink href="/contact" className="w-full sm:w-auto bg-yellow-400 text-black hover:bg-yellow-500 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg transition-all duration-300 min-h-[44px] inline-flex items-center justify-center">
              Contact us
            </LocaleLink>
            <LocaleLink href="/contact" className="w-full sm:w-auto border-2 border-white text-white hover:bg-white hover:text-black px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg transition-all duration-300 min-h-[44px] inline-flex items-center justify-center">
      ...
      <section id="institutional-advisory" className="py-12 sm:py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-black mb-3 sm:mb-4">Institutional Advisory</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-2">Advisory for governments and international institutions.</p>
            <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl mx-auto">Institutional references — Our work with governments and institutions</p>
          </div>

          <div className="bg-gray-50 p-6 sm:p-8 lg:p-12 rounded-2xl">
            <div className="grid grid-cols-1 gap-8 sm:gap-10 lg:grid-cols-2 lg:gap-12 mb-8 sm:mb-12">
              <div>
                <h3 className="text-xl sm:text-2xl font-serif text-black mb-4 sm:mb-6">Institutional clients</h3>
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-serif text-black mb-4 sm:mb-6">Results achieved</h3>
                <div className="grid grid-cols-2 gap-4 sm:gap-6">
                  <div className="text-center bg-white p-4 sm:p-6 rounded-lg">
                    <div className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-1 sm:mb-2">12</div>
                    <div className="text-gray-600 text-sm sm:text-base">Countries advised</div>
                  </div>
                  <div className="text-center bg-white p-4 sm:p-6 rounded-lg">
                    <div className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-1 sm:mb-2">€2.5B</div>
                    <div className="text-gray-600 text-sm sm:text-base">Economic impact</div>
                  </div>
                  <div className="text-center bg-white p-4 sm:p-6 rounded-lg">
                    <div className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-1 sm:mb-2">150+</div>
                    <div className="text-gray-600 text-sm sm:text-base">Reforms delivered</div>
                  </div>
                  <div className="text-center bg-white p-4 sm:p-6 rounded-lg">
                    <div className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-1 sm:mb-2">+35%</div>
                    <div className="text-gray-600 text-sm sm:text-base">Average growth</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="mt-4 sm:mt-6">
                <button className="bg-yellow-600 text-white hover:bg-yellow-700 px-6 sm:px-8 py-3 rounded-lg font-semibold transition-all duration-300 min-h-[44px]">
